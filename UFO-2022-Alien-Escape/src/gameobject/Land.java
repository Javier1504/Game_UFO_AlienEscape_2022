...
public class Land {
	...
	public static final int LAND_POSY = 103; //ukuran y dari land 
	//deklarasi class
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("data/land1.png"); //menerima input gambar
		land2 = Resource.getResouceImage("data/land2.png"); //menerima input gambar
		land3 = Resource.getResouceImage("data/land3.png"); //menerima input gambar
	...
	public void update(){ //update saat land seolah bergerak
